...
public class CripplingArrow extends CustomArrow
{
    private int amp = 10;
    ...
    {
        super(C.DARK_GRAY + "Crippling Arrow");
    }
    ...
    public void hit(Projectile p, ProjectileHitEvent e)
    {
        ...
        {
            ((LivingEntity) e.getHitEntity()).addPotionEffect(new PotionEffect(PotionEffectType.SLOW, getDurationInSeconds(), amp));
            ((LivingEntity) e.getHitEntity()).addPotionEffect(new PotionEffect(PotionEffectType.JUMP, getDurationInSeconds(), 250));
